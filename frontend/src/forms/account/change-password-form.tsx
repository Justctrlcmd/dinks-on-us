...
export function ChangePasswordForm() {
  ...
  return <form onSubmit={submit} className="grid gap-4 lg:flex lg:flex-1 lg:flex-col" noValidate>
    ...
    <Button className="w-fit lg:mt-auto" disabled={mutation.isPending || isMutationRateLimited(mutation)} type="submit">{mutationButtonLabel("Changing password…", "Change password", mutation)}</Button>
  </form>;
}
