...
{
    private const RULE = 'Walk-in customers receive the verification email after Staff creates the reservation because payment is recorded as verified at creation.';
    ...
    public function up(): void
    {
        ...
        DB::transaction(function () use ($subheaderId, $sortOrder): void {
