    ...
    public function up(): void
    {
        ...
        $subheaders = [
            ...
            'reservation-rules' => [
                ...
                'Reservation Email Notifications' => ['Dinks On Us sends a customer email after staff or management reviews an online reservation and submitted payment proof.', 'If the reservation is verified, the customer will receive a confirmation email stating that the reservation has been approved and confirmed.', 'If the reservation is rejected, the customer will receive an email informing them that the reservation was not approved and explaining the reason.', 'If a verified reservation is rescheduled, the customer will receive an email showing the updated court, date, and time.', 'Walk-in customers receive the verification email after Staff creates the reservation because payment is recorded as verified at creation.', 'Customers are responsible for providing a valid and accessible email address when submitting their reservation.'],
